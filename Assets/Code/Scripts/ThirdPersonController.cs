...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            _hipsStabilizer.rotation = Quaternion.Euler(_mouseY, _hipsStabilizer.rotation.eulerAngles.y, 0.0f);
        }
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                _hipsStabilizer.rotation = Quaternion.Euler(0.0f, rotation, 0.0f);
            }
            ...
            Vector3 movementDirection = targetDirection.normalized * _speed;
